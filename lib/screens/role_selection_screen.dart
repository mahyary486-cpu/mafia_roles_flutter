...
class _RoleSelectionScreenState extends State<RoleSelectionScreen>
  ...
  Future<void> _addCustomRole() async {
    // Custom roles aren't ready yet - show a simple placeholder instead
    // of the real creation dialog.
    await showDialog<void>(
      context: context,
      builder: (context) => AlertDialog(
        title: const TrText('Coming Soon'),
        content: const TrText('Custom roles will be available in a future update.'),
        actions: [
          TextButton(
  ...
  Future<void> _addCustomRoleUnused() async {
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              label: Row(mainAxisSize: MainAxisSize.min, children: const [TrText('Add Custom Role')]),
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Row(mainAxisSize: MainAxisSize.min, children: const [TrText('Start Game', style: TextStyle(fontSize: 14))]),
                            ),
                          ),
                        ],
                      ),
