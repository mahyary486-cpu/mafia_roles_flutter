    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(titleFa, style: const TextStyle(fontSize: 14, color: AppColors.textGold)),
          ...
          for (final s in sections) ...[
            ...
            Text(s.titleFa, style: const TextStyle(color: AppColors.textGold, fontSize: 13)),
            const SizedBox(height: 6),
            Text(s.bodyEn, style: const TextStyle(color: AppColors.textSecondary, height: 1.6)),
            const SizedBox(height: 4),
            Text(s.bodyFa, style: const TextStyle(color: AppColors.textGold, height: 1.8, fontSize: 13)),
          ...
          const Center(
            child: Text(
              ...
              'tracking. / فعلاً فقط جنبه مرجع دارد؛ هنوز به ردیابی خودکار بازی وصل نشده.',
