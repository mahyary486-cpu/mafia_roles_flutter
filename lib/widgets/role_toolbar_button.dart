...
class RoleToolbarButton extends StatefulWidget {
  ...
  /// True when this player has inherited the mafia's shooting ability
  /// because the Godfather is gone - shows a small Godfather icon in
  /// the opposite corner from the player-number badge.
  final bool showsSuccessorBadge;
  ...
  const RoleToolbarButton({
    ...
    this.playerNumber,
    this.showsSuccessorBadge = false,
  });
          ...
          child: Opacity(
            ...
            child: Stack(
              ...
              child: Column(
                ...
                // Which player currently holds this role, so the game
                // master doesn't have to cross-reference the roster.
