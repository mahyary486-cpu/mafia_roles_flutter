      ...
      return StatefulBuilder(
        builder: (context, setState) {
          return AlertDialog(
            ...
            title: const TrText('Custom Role', style: TextStyle(fontSize: 16)),
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const TrText('Side', style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                  ...
                  const SizedBox(height: 10),
                  const TrText('Acts by Day / Night', style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                  const SizedBox(height: 4),
                  SizedBox(
                    width: double.infinity,
                    child: SegmentedButton<RoleActionTiming>(
                      ...
                      segments: const [
                        ButtonSegment(
                          ...
                          label: TrText('Day', style: TextStyle(fontSize: 11)),
                          icon: Icon(Icons.wb_sunny_rounded, size: 15),
                        ),
                        ButtonSegment(
                          value: RoleActionTiming.night,
                          label: TrText('Night', style: TextStyle(fontSize: 11)),
                  ...
                  const SizedBox(height: 10),
                  const TrText('Ability type', style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                  const SizedBox(height: 4),
                  Wrap(
                    spacing: 5,
                    runSpacing: 5,
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<RoleType?>(
                      ...
                      decoration: const InputDecoration(isDense: true),
                      value: insertAfter,
                      hint: const TrText('End of list', style: TextStyle(fontSize: 11)),
                      items: [
                        const DropdownMenuItem<RoleType?>(
                          value: null,
                          child: TrText('End of list', style: TextStyle(fontSize: 11)),
                        ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: const TrText('Cancel', style: TextStyle(fontSize: 12)),
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: const TrText('Add', style: TextStyle(fontSize: 12)),
                    ),
                  ),
                ],
              ),
