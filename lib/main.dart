...
void main() async {
  ...
  // Open already in the device's own language if it's one we support,
  // instead of always starting in English.
  LocaleService.instance
      .applyDeviceDefaultLanguage(WidgetsBinding.instance.platformDispatcher.locale.toString());
