...
class Role {
  ...
  /// For custom roles only: another role type whose icon should always
  /// be shown paired right next to this one's icon on the affected
  /// player (e.g. the Priest's icon shown paired with Natasha's, since
  /// the Priest cures her silence). Purely visual - a reminder for the
  /// game master, same idea as the Judge/Psycho or Thief/stolen-role
  /// pairing already used for a couple of built-in roles.
  final RoleType? pairedWithRoleType;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'pairedWithRoleType': pairedWithRoleType?.name,
      };
  ...
  factory Role.fromJson(Map<String, dynamic> json) {
    return Role(
      ...
      pairedWithRoleType: (json['pairedWithRoleType'] as String?) == null
          ? null
          : RoleType.values.byName(json['pairedWithRoleType'] as String),
    );
  }
}
