...
enum RoleActionCategory {
  ...
  /// No real game effect at all - just marks the target with this
  /// role's icon, at night and carried into the next day, purely so
  /// the game master remembers who was targeted (e.g. a silence the
  /// app can't enforce itself, since this is a physical game).
  infoOnly,
}
